import {MusBoxOption, DictionaryArray, toNameMap} from "../synth/SynthConfig";
import {Song} from "../synth/synth";
import {HTML} from "imperative-html/dist/esm/elements-strict";

export interface ChannelColors extends MusBoxOption {
...
export class ColorConfig {
	public static readonly themes: {[name: string]: string} = {
		...
		"light classic": `
			...
			.musboxEditor button, .musboxEditor select {
